...
export function SelectAllCheckbox({
  selected, visibleIds, onToggleAll, testId = 'select-all',
}: {
...
export function RowSelectCheckbox({
  id, label, selected, onToggle, testId = 'row-select',
}: {
  ...
  return (
    <input
      ...
      onChange={() => { /* onClick owns it: onChange cannot see the shift key. */ }}
    />
  );
}
