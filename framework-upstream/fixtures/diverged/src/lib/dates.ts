...
/* FIXTURE MARKER — a DELIBERATE app-side modification of a seed file. This line is load-bearing:
 * the conformance suite asserts that an upgrade routes this file to REVIEW and that this exact
 * marker survives. If an upgrade ever deletes this comment, the three-way rule is broken. */
export const FIXTURE_DIVERGENCE_MARKER = 'app-modified-on-purpose';
