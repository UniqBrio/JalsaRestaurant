...
# The .codex copy of the adapter - NOT .claude's. Pointing this test at the other copy proved
# the wrong file and left this one never executed, which is the exact failure described above.
ADAPTER="$ROOT/.codex/hooks/pre-tool-use-guard.mjs"
PASS=0; FAIL=0
