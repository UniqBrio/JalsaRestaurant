...
export function MetricCard({
  ...
  // `unit` is optional on FormatOptions, so an absent unit is ABSENT rather than an explicit
  // undefined - otherwise it overwrites whatever formatOptions already carried.
  ...
  const showComparison = result.value !== null && result.growth !== null && definition.comparisonPeriod !== 'none';
  ...
  return (
    ...
    >
      ...
      <strong className="metric__value" data-testid={`${id}-value`}>
        {value}
      </strong>
