...
export function ModuleAccessPanel({
  ...
  return (
    <div className="module-access" data-testid={testId}>
      ...
      <p className="module-access__hint">Everything is off until you grant it. Confidential fields are marked.</p>
            ...
            <li key={section.id} className="module-access__section">
              ...
              >
                ...
                {section.comingSoon ? (
                  ...
                  <span className="module-access__count">
                    {granted}/{total}
                  </span>
                )}
              </button>
                    ...
                    return (
                      <li key={cap.id} className="module-access__cap">
                        ...
                        >
                          ...
                          {cap.confidential && <span className="module-access__confidential">Confidential</span>}
