...
const consoleSink: Sink = (r) => {
  // The one place in the application where console IS the destination rather than a leftover
  // debug line. Everything else routes here so a real sink can replace it in one edit.
