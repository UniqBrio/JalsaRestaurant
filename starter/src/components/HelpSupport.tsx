...
export function HelpSupport({
  ...
  return (
    <section className="help" aria-labelledby={`${testId}-heading`} data-testid={testId}>
      <h2 className="help__heading" id={`${testId}-heading`}>{heading}</h2>
        ...
        <ul className="help__channels">
          {email && (
            <li className="help__channel">
              <a className="help__link" href={`mailto:${email}`} data-testid={`${testId}-email`}>
                <span className="help__icon" aria-hidden="true">✉</span>
          ...
          {phone && (
            <li className="help__channel">
              <a className="help__link" href={`tel:${phone.replace(/\s+/g, '')}`} data-testid={`${testId}-call`}>
                <span className="help__icon" aria-hidden="true">✆</span>
