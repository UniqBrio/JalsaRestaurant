...
import {
  type DateFilterState, type DatePreset, type ListState, DATE_PRESET_LABELS,
...
export interface SortableColumn { key: string; label: string }
  ...
  return (
    <div className="list-controls" data-testid={testId}>
      ...
      <div className="list-controls__status" role="status" aria-live="polite">
        <span data-testid={`${testId}-count`}>{matching} of {total}</span>
        {anyActive && (
          <button
            type="button"
